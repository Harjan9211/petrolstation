...
<div id="templatemo_wrapper">
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="sno" DataSourceID="SqlDataSource1" Height="117px" Width="308px">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DatabaseConnectionString %>" SelectCommand="SELECT sno, type_fuel, date_filling, empno, name, vehicle, quantity
FROM     slip
WHERE  (sno =
                      (SELECT MAX(sno) AS max
                       FROM      slip AS slip_1))"></asp:SqlDataSource>
    </div>
    </form> 
            </div>
